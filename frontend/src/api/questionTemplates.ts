...
export async function getQuestionTemplatesTree(
  id: number
): Promise<AxiosResponse<{ questionTemplatesTree: QuestionTemplateTreeData }>> {
  return client.get(`script_templates/${id}/question_templates/tree`);
}
